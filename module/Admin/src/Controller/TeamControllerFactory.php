...
class TeamControllerFactory implements FactoryInterface
{
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null): TeamController
    {
        ...
        $userWithNameDataService = $container->get(UserWithName::class);
        assert($userWithNameDataService instanceof UserWithName);
    ...
    public function createService(ServiceLocatorInterface $serviceLocator): TeamController
    {
        ...
        return $this->__invoke($container, TeamController::class);
    }
}