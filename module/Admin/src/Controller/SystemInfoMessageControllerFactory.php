...
class SystemInfoMessageControllerFactory implements FactoryInterface
{
     ...
     */
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null): SystemInfoMessageController
    {
     ...
     * @throws NotFoundExceptionInterface
     */
    public function createService(ServiceLocatorInterface $serviceLocator): SystemInfoMessageController
    {
        $container = method_exists($serviceLocator, 'getServiceLocator') ? $serviceLocator->getServiceLocator() : $serviceLocator;

        return $this->__invoke($container, SystemInfoMessageController::class);
    }
}