...
class PublishedPublicationControllerFactory implements FactoryInterface
{
     ...
     * @throws NotFoundExceptionInterface
     */
    public function createService(ServiceLocatorInterface $serviceLocator): PublishedPublicationController
    {
        $container = method_exists($serviceLocator, 'getServiceLocator') ? $serviceLocator->getServiceLocator() : $serviceLocator;

        return $this->__invoke($container, PublishedPublicationController::class);
    }
}