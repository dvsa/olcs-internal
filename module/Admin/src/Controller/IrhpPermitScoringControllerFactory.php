...
class IrhpPermitScoringControllerFactory implements FactoryInterface
{
     ...
     */
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null): IrhpPermitScoringController
    {
    ...
    public function createService(ServiceLocatorInterface $serviceLocator): IrhpPermitScoringController
    {
        ...
        return $this->__invoke($container, IrhpPermitScoringController::class);
    }
}