...
return [
    ...
    'query_cache' => [
        ...
        'ttl' => [
            \Dvsa\Olcs\Transfer\Query\CacheableMediumTermQueryInterface::class => intval('%cqrs_cache_medium_ttl%'),
            \Dvsa\Olcs\Transfer\Query\CacheableLongTermQueryInterface::class => intval('%cqrs_cache_long_ttl%'),
        ],
    ],
